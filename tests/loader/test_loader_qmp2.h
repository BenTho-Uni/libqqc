#ifndef LIBQQC_TEST_LOADER_QMP2_H
#define LIBQQC_TEST_LOADER_QMP2_H
...
namespace libqqc {
    ...
    ///
    /// @brief Holding class for testing Loader_qmp2 functions
    ///
    /// @details This class holds the setup for testing the 
    /// Loader_qmp2 functions
    ///

    class Test_Loader_qmp2 {
        private: 
...
#endif //LIBQQC_TEST_LOADER_QMP2_H
