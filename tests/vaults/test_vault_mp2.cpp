...
namespace libqqc {
    bool Test_Vault_mp2 :: test_Vault_mp2() {
        bool result = true;

        Vault_mp2 vault2(mnocc, mnvirt, mnao, m1Dtol, mprnt_lvl, m1Dgrid,
    ...
    bool Test_Vault_mp2 :: run_all_tests(ostringstream &out) {
        ...
        bool b_Vault_mp2 = test_Vault_mp2();
        out << "    Testing Vault_mp2::Vault_mp2()             ... " << flush
            << (b_Vault_mp2 ? "passed" : "failed") << endl;
        ...
        result = b_Vault_mp2 && b_check_data_validity && b_get_mnocc
            && b_get_mnvirt
